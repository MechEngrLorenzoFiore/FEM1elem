...
simulations = ["test_2022-11-30-19-12-59",
               "test_2022-11-30-19-46-56",
               "test_2022-12-01-03-14-28"]
...
for i, c in zip(range(n), colors):
    ...
    # plot results
    plt.plot(-E11*1e2,-S11/1e6,'-o', color=c, linewidth=1, markersize=2, label=testID+Trange )


plt.xlabel("E11 [%]", fontsize=axlebelfont )
plt.ylabel("S11 [MPa]", fontsize=axlebelfont )
plt.legend( title=model.replace(" ","\n"),
